  ...
  return (
    <label className="inline-flex items-center relative cursor-pointer">
      ...
      <div className="relative w-[110px] h-[50px] 
        bg-yellow-200 peer-checked:bg-zinc-500 
      ...
      <svg
        ...
        width={512}
        viewBox="0 0 24 24"
        className="fill-black opacity-60 peer-checked:opacity-70 m-2 peer-checked:fill-white absolute w-6 h-6 right-[13px]"
        xmlns="http://www.w3.org/2000/svg"
      >
